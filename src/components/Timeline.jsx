...
const ENTRIES = [
  ...
  },
  {
    ...
    desc: "Building clean interfaces, supporting dashboard work, and automating reporting workflows with Python scripts.",
  },
  {
    date: "2026",
    ...
    <section id='experience' className='section'>
      <div className='container'>
        ...
        <p className='section-subtitle'>
          Education, projects, and professional experience that shape my growth
          as a developer.
        </p>
